...
---------------------activation steps----------------------------
__________________this process also can be done without cmd____________

do not try to modify the given bat file unless you are a programmer (except to change your password)
...
inspired from sherlock project :> https://github.com/sherlock-project/sherlock.git
